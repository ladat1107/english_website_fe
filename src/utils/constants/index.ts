...
export const PATHS = {
    ...
    CLIENT: {
        ...
        PROFILE: '/profile',
        FLASHCARD: '/flashcard',
        FLASHCARD_CREATE: '/flashcard/tao-moi',
        FLASHCARD_EDIT: (deckId: string) => `/flashcard/chinh-sua/${deckId}`,
        FLASHCARD_DETAIL: (id: string) => `/flashcard/${id}`,
        FLASHCARD_FLIP: (id: string) => `/flashcard/${id}/hoc`,
        FLASHCARD_LEARN: (id: string) => `/flashcard/${id}/luyen-tap`,
        FLASHCARD_TEST: (id: string) => `/flashcard/${id}/kiem-tra`,
        FLASHCARD_MATCH: (id: string) => `/flashcard/${id}/ghep-doi`,
